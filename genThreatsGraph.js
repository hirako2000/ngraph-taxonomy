...
// Country nodes
g.addNode("Country: China", {
  description: ""
});
g.addNode("Country: Palestine", {
  description: ""
});
g.addNode("Country: Iran", {
  description: ""
});
g.addNode("Country: Pakistan", {
  description: ""
});
g.addNode("Country: Russia", {
  description: ""
});
g.addNode("Country: North Korea", {
  description: ""
});
g.addNode("Country: United States", {
  description: ""
});
g.addNode("Country: Vietnam", {
  description: ""
});
g.addNode("Country: South Korea", {
  description: ""
});

// Objective nodes
//g.addNode('Objective: Espionage', {
//  description: ""
//});
//g.addNode('Objective: Hacktivism', {
//  description: ""
//});
//g.addNode("Objective: Financial Gain", {
//  description: "TODO"
//});

// Tool nodes
g.addNode('Tool: BlackShades', {
  description: ""
});
g.addNode('Tool: DarkComet', {
  link: "https://attack.mitre.org/software/S0334/",
  description: "DarkComet is a Windows remote administration tool and backdoor."
});

g.addNode('Tool: PoisonIvy', {
  description: ""
});
g.addNode('Tool: QuasarRAT', {
...
g.addNode("Tool: PowerShell Empire", {
...
g.addNode("Tool: Zuguo", {
  link: "",
  description: ""
})

g.addNode("Tool: Alice\'s Rabbit Hole", {
  link: "",
  description: ""
});
g.addNode("Tool: Briba", {
...
g.addNode("Tool: Isastart", {
  link: "",
  description: ""
});
g.addNode("Tool: Leouncia", {
...
g.addNode("Tool: PCShare", {
  link: "",
  description: ""
});
g.addNode("Tool: Skeleton Key", {
...
g.addNode("Tool: SlyPidgin", {
  link: "",
  description: ""
});
g.addNode("Tool: VinSelf", {
  link: "",
  description: ""
});

g.addNode("Tool: Lecna", {
  link: "",
  description: "TODO"
});

g.addNode("Tool: AgentDrable", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: DNSpionage", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: Karkoff", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: TWOTONE", {
  link: "",
  description: "TODO"
});
...
g.addNode("Tool: Glimpse", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: Helminth", {
...
g.addNode("Tool: Jason", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: MacDownloader", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: PoisonFrog", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: PupyRAT", {
  link: "",
  description: ""
});
g.addNode("Tool: RGDoor", {
...
g.addNode("Tool: ThreeDollars", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: TinyZbot", {
  link: "https://attack.mitre.org/software/S0004/",
  description: "TinyZBot is a bot written in C# that was developed by Cleaver."
});
g.addNode("Tool: Toxocara", {
  link: "",
  description: ""
});
g.addNode("Tool: Trichuris", {
  link: "",
  description: ""
});
g.addNode("Tool: TwoFace", {
  link: "",
  description: ""
});

g.addNode("Tool: MechaFlounder", {
  link: "",
  description: ""
});
g.addNode("Tool: Mimikatz", {
...
g.addNode("Tool: TREKX", {
  link: "",
  description: ""
});

g.addNode("Tool: HARDCANDY", {
  link: "",
  description: ""
});
g.addNode("Tool: SABER1", {
  link: "",
  description: ""
});
g.addNode("Tool: SABER2", {
  link: "",
  description: ""
});
g.addNode("Tool: ZooPark", {
...
g.addNode("Tool: CASHY200", {
  link: "",
  description: ""
});
g.addNode("Tool: Diezen", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: Eye", {
...
g.addNode("Tool: Hisoka", {
  link: "",
  description: ""
});
g.addNode("Tool: Hisoka Netero", {
  link: "",
  description: ""
});
g.addNode("Tool: HyphenShell", {
  description: ""
});
g.addNode("Tool: Killua", {
  link: "",
  description: ""
});
g.addNode("Tool: Sakabota Framework", {
  link: "",
  description: ""
});

g.addNode("Tool: DanBot", {
  link: "",
  description: ""
});

g.addNode("Tool: AutoCore", {
  link: "",
  description: ""
});
g.addNode("Tool: Cadlotcorg", {
  link: "",
  description: ""
});
g.addNode("Tool: Dello RAT", {
  link: "",
  description: ""
});
g.addNode("Tool: Imminent Monitor", {
  link: "",
  description: ""
});
g.addNode("Tool: KDALogger", {
  link: "",
  description: ""
});
g.addNode("Tool: Koadic", {
...
g.addNode("Tool: NetWire", {
  link: "",
  description: ""
});
g.addNode("Tool: PoshC2", {
...
g.addNode("Tool: Poylog", {
  link: "",
  description: ""
});
g.addNode("Tool: Schoolbag", {
  link: "",
  description: ""
});

g.addNode("Tool: FORELORD", {
  link: "",
  description: ""
});
g.addNode("Tool: LaZagne", {
...
g.addNode("Tool: Metasploit", {
  link: "",
  description: ""
});
g.addNode("Tool: PowerStats", {
...
g.addNode("Tool: LuminosityLink", {
  link: "",
  description: ""
});
g.addNode("Tool: njRAT", {
...
g.addNode("Tool: Peppy", {
  link: "",
  description: ""
});

g.addNode("Tool: Carbon-DLL", {
...
g.addNode("Tool: Nautilus", {
  link: "",
  description: "TODO"
});
g.addNode("Tool: Neuron", {
  link: "",
  description: ""
});
g.addNode("Tool: PyFlash", {
  link: "",
  description: ""
});
g.addNode("Tool: Skipper", {
  link: "",
  description: ""
});
g.addNode("Tool: Snake", {
  link: "",
  description: ""
});
g.addNode("Tool: Tavdig", {
  link: "",
  description: ""
});

g.addNode("Tool: ClientX", {
  link: "",
  description: ""
});
g.addNode("Tool: Ddex Loader", {
  link: "",
  description: ""
});
g.addNode("Tool: Havex", {
  link: "",
  description: ""
});
g.addNode("Tool: Karagany", {
...
g.addNode("Tool: EVILTOSS", {
  link: "",
  description: ""
});
g.addNode("Tool: HIDEDRV", {
...
g.addNode("Tool: LoJack", {
  link: "",
  description: ""
});
g.addNode("Tool: Scaramouche", {
  link: "",
  description: ""
});
g.addNode("Tool: Sedkit Exploit Kit", {
  link: "",
  description: ""
});
g.addNode("Tool: SEDUPLOADER", {
  link: "",
  description: ""
});
g.addNode("Tool: SHARPFRONT", {
  link: "",
  description: ""
});
g.addNode("Tool: Sofacy downloader", {
  link: "",
  description: ""
});
g.addNode("Tool: X-Agent", {
  link: "",
  description: ""
});
g.addNode("Tool: X-Tunnel", {
...
g.addNode("Tool: Zebrocy", {
  link: "",
  description: ""
});

g.addNode("Tool: BadRabbit", {
  link: "",
  description: ""
});
g.addNode("Tool: BlackEnergy", {
...
g.addNode("Tool: Industroyer", {
  link: "",
  description: ""
});
g.addNode("Tool: KillDisk", {
  link: "",
  description: ""
});
g.addNode("Tool: NotPetya", {
...
g.addNode("Tool: PSCrypt", {
  link: "",
  description: ""
});
g.addNode("Tool: TeleBot", {
  link: "",
  description: ""
});
g.addNode("Tool: TeleDoor", {
  link: "",
  description: ""
});
g.addNode("Tool: xData", {
  link: "",
  description: ""
});

g.addNode("Tool: Brambul", {
  link: "",
  description: ""
});
g.addNode("Tool: DarkMessenger", {
  link: "",
  description: ""
});
g.addNode("Tool: DarkSeoul", {
  link: "",
  description: ""
});
g.addNode("Tool: Destover", {
  link: "",
  description: ""
});
g.addNode("Tool: Duuzer", {
  link: "",
  description: ""
});
g.addNode("Tool: HOPLIGHT", {
...
g.addNode("Tool: Joanap", {
  link: "",
  description: ""
});
g.addNode("Tool: KorHigh", {
  link: "",
  description: ""
});
g.addNode("Tool: LiveJinx", {
  link: "",
  description: ""
});
g.addNode("Tool: Volgmer", {
...
g.addNode("Tool: AfterMidnight", {
  link: "",
  description: ""
});
g.addNode("Tool: Assassin", {
  link: "",
  description: ""
});
g.addNode("Tool: Marble Framework", {
  link: "",
  description: ""
});

g.addNode("Tool: Cobalt Strike", {
...
g.addNode("Tool: Denis", {
  link: "https://attack.mitre.org/software/S0354/",
  description: "Denis is a Windows backdoor and Trojan"
});
g.addNode("Tool: Goopy", {
  link: "",
  description: ""
});
g.addNode("Tool: JEShell", {
  link: "",
  description: ""
});
g.addNode("Tool: KerrDown", {
  link: "",
  description: ""
});
g.addNode("Tool: Ratsnif", {
  link: "",
  description: ""
});
g.addNode("Tool: Remy", {
...
g.addNode("Tool: Rizzo", {
  link: "",
  description: ""
});
g.addNode("Tool: RolandRAT", {
  link: "",
  description: ""
});

g.addNode("Tool: Nemim", {
  link: "",
  description: ""
});

// ALUMINUM SARATOGA
g.addNode('Threat Group: ALUMINUM SARATOGA', {
...
g.addLink("Threat Group: ALUMINUM SARATOGA", "Country: Palestine");

//g.addLink("ALUMINUM SARATOGA", "Objective: Hacktivism");
//g.addLink("ALUMINUM SARATOGA", "Objective: Espionage");

g.addLink("Threat Group: ALUMINUM SARATOGA", "Tool: BlackShades");
g.addLink("Threat Group: ALUMINUM SARATOGA", "Tool: DarkComet");
g.addLink("Threat Group: ALUMINUM SARATOGA", "Tool: PoisonIvy");
g.addLink("Threat Group: ALUMINUM SARATOGA", "Tool: QuasarRAT");
g.addLink("Threat Group: ALUMINUM SARATOGA", "Tool: XtremeRat");


g.addNode('Threat Group: BRONZE ATLAS', {
...
g.addLink("Threat Group: BRONZE ATLAS", "Country: China");

g.addLink("Threat Group: BRONZE ATLAS", "Tool: Acehash");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: Daserf");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: China Chopper");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: Dicey MSDN");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: HUC Proxy Malware (Htran)");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: Mimikatz");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: PlugX");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: PowerShell Empire");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: RbDoor");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: Speculoos");
g.addLink("Threat Group: BRONZE ATLAS", "Tool: Winnti");

g.addNode('Threat Group: BRONZE BUTLER', {
...
g.addLink("Threat Group: BRONZE BUTLER", "Country: China");
//g.addLink("BRONZE BUTLER", "Objective: Espionage");

g.addLink("Threat Group: BRONZE BUTLER", "Tool: ABK");
g.addLink("Threat Group: BRONZE BUTLER", "Tool: Daserf");
g.addLink("Threat Group: BRONZE BUTLER", "Tool: xxmm");


g.addNode('Threat Group: BRONZE EDISON', {
...
g.addLink("Threat Group: BRONZE EDISON", "Country: China");
g.addLink("Threat Group: BRONZE EDISON", "Tool: Gh0st RAT");
g.addLink("Threat Group: BRONZE EDISON", "Tool: Wkysol");
g.addLink("Threat Group: BRONZE EDISON", "Tool: ZXPortMap");

g.addNode('Threat Group: BRONZE ELGIN', {
...
g.addLink("Threat Group: BRONZE ELGIN", "Country: China");
g.addLink("Threat Group: BRONZE ELGIN", "Tool: Elise");


g.addNode('Threat Group: BRONZE EXPORT', {
...
g.addLink("Threat Group: BRONZE EXPORT", "Country: China");
g.addLink("Threat Group: BRONZE ELGIN", "Tool: Conpee");
g.addLink("Threat Group: BRONZE ELGIN", "Tool: PwDump");


// Bronze Express
g.addNode('Threat Group: BRONZE EXPRESS', {
...
g.getNode('Threat Group: BRONZE EXPRESS').data.tools.forEach(tool => {
  g.addLink("Threat Group: BRONZE EXPRESS", "Tool: " + tool);
});
g.addLink("Threat Group: BRONZE EXPRESS", "Country: China");

// Bronze Firestone
g.addNode('Threat Group: BRONZE FIRESTONE', {
...
g.getNode('Threat Group: BRONZE FIRESTONE').data.tools.forEach(tool => {
  g.addLink("Threat Group: BRONZE FIRESTONE", "Tool: " + tool);
});
g.addLink("Threat Group: BRONZE FIRESTONE", "Country: China");

// Bronze Littlewood
g.addNode('Threat Group: BRONZE FLEETWOOD', {
...
g.getNode('Threat Group: BRONZE FLEETWOOD').data.tools.forEach(tool => {
  g.addLink("Threat Group: BRONZE FLEETWOOD", "Tool: " + tool);
});
g.addLink("Threat Group: BRONZE FLEETWOOD", "Country: China");


// BRONZE GENEVA
g.addNode('Threat Group: BRONZE GENEVA', {
...
g.getNode('Threat Group: BRONZE GENEVA').data.tools.forEach(tool => {
  g.addLink("Threat Group: BRONZE GENEVA", "Tool: " + tool);
});
g.addLink("Threat Group: BRONZE GENEVA", "Country: China");


// COBALT DICKENS
g.addNode('Threat Group: COBALT DICKENS', {
...
g.getNode('Threat Group: COBALT DICKENS').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT DICKENS", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT DICKENS", "Country: Iran");


//COBALT EDGEWATER
g.addNode('Threat Group: COBALT EDGEWATER', {
...
g.getNode('Threat Group: COBALT EDGEWATER').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT EDGEWATER", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT EDGEWATER", "Country: Iran");


//COBALT GYPSY
g.addNode('Threat Group: COBALT GYPSY', {
...
g.getNode('Threat Group: COBALT GYPSY').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT GYPSY", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT GYPSY", "Country: Iran");


// COBALT  HICKMAN
g.addNode('Threat Group: COBALT HICKMAN', {
...
g.getNode('Threat Group: COBALT HICKMAN').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT HICKMAN", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT HICKMAN", "Country: Iran");


// COBALT JUNO
g.addNode('Threat Group: COBALT JUNO', {
...
g.getNode('Threat Group: COBALT JUNO').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT JUNO", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT JUNO", "Country: Iran");

// COBALT KATANA
g.addNode('Threat Group: COBALT KATANA', {
...
g.getNode('Threat Group: COBALT KATANA').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT KATANA", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT KATANA", "Country: Iran");


// COBALT LYCEUM
g.addNode('Threat Group: COBALT LYCEUM', {
...
g.getNode('Threat Group: COBALT LYCEUM').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT LYCEUM", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT LYCEUM", "Country: Iran");


// COBALT TRINITY
g.addNode('Threat Group: COBALT TRINITY', {
...
g.getNode('Threat Group: COBALT TRINITY').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT TRINITY", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT TRINITY", "Country: Iran");


// COBALT ULSTER
g.addNode('Threat Group: COBALT ULSTER', {
...
g.getNode('Threat Group: COBALT ULSTER').data.tools.forEach(tool => {
  g.addLink("Threat Group: COBALT ULSTER", "Tool: " + tool);
});
g.addLink("Threat Group: COBALT ULSTER", "Country: Iran");


// 
g.addNode('Threat Group: COPPER FIELDSTONE', {
...
g.getNode('Threat Group: COPPER FIELDSTONE').data.tools.forEach(tool => {
  g.addLink("Threat Group: COPPER FIELDSTONE", "Tool: " + tool);
});
g.addLink("Threat Group: COPPER FIELDSTONE", "Country: Pakistan");


// IRON HUNTER
g.addNode('Threat Group: IRON HUNTER', {
...
g.getNode('Threat Group: IRON HUNTER').data.tools.forEach(tool => {
  g.addLink("Threat Group: IRON HUNTER", "Tool: " + tool);
});
g.addLink("Threat Group: IRON HUNTER", "Country: Russia");


// IRON LIBERTY
g.addNode('Threat Group: IRON LIBERTY', {
...
g.getNode('Threat Group: IRON LIBERTY').data.tools.forEach(tool => {
  g.addLink("Threat Group: IRON LIBERTY", "Tool: " + tool);
});
g.addLink("Threat Group: IRON LIBERTY", "Country: Russia");


// IRON TWILIGHT
g.addNode('Threat Group: IRON TWILIGHT', {
...
g.getNode('Threat Group: IRON TWILIGHT').data.tools.forEach(tool => {
  g.addLink("Threat Group: IRON TWILIGHT", "Tool: " + tool);
});
g.addLink("Threat Group: IRON TWILIGHT", "Country: Russia");

// IRON VIKING
g.addNode('Threat Group: IRON VIKING', {
...
g.getNode('Threat Group: IRON VIKING').data.tools.forEach(tool => {
  g.addLink("Threat Group: IRON VIKING", "Tool: " + tool);
});
g.addLink("Threat Group: IRON VIKING", "Country: Russia");

// NICKEL ACADEMY
g.addNode('Threat Group: NICKEL ACADEMY', {
...
g.getNode('Threat Group: NICKEL ACADEMY').data.tools.forEach(tool => {
  g.addLink("Threat Group: NICKEL ACADEMY", "Tool: " + tool);
});
g.addLink("Threat Group: NICKEL ACADEMY", "Country: North Korea");

// NICKEL GLADSTONE
g.addNode('Threat Group: NICKEL GLADSTONE', {
...
g.getNode('Threat Group: NICKEL GLADSTONE').data.tools.forEach(tool => {
  g.addLink("Threat Group: NICKEL GLADSTONE", "Tool: " + tool);
});
g.addLink("Threat Group: NICKEL GLADSTONE", "Country: North Korea");

// PLATINUM TERMINAL
g.addNode('Threat Group: PLATINUM TERMINAL', {
...
g.getNode('Threat Group: PLATINUM TERMINAL').data.tools.forEach(tool => {
  g.addLink("Threat Group: PLATINUM TERMINAL", "Tool: " + tool);
});
g.addLink("Threat Group: PLATINUM TERMINAL", "Country: United States");

// TIN WOODLAWN
g.addNode('Threat Group: TIN WOODLAWN', {
...
g.getNode('Threat Group: TIN WOODLAWN').data.tools.forEach(tool => {
  g.addLink("Threat Group: TIN WOODLAWN", "Tool: " + tool);
});
g.addLink("Threat Group: TIN WOODLAWN", "Country: Vietnam");

// TUNGSTEN BRIDGE
g.addNode('Threat Group: TUNGSTEN BRIDGE', {
...
g.getNode('Threat Group: TUNGSTEN BRIDGE').data.tools.forEach(tool => {
  g.addLink("Threat Group: TUNGSTEN BRIDGE", "Tool: " + tool);
});
g.addLink("Threat Group: TUNGSTEN BRIDGE", "Country: South Korea");

// Create 3D Layout
var layout = createLayout(g, {
  iterations: 250,
  saveEach: 3000, // Save each `nth` iteration
  outDir: './threatGroups', // Save results into `./myFolder`
