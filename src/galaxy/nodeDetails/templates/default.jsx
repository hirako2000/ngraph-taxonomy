    ...
    <div className='container-fluid row'>
      ...
      <div className='visible-xs-block'>
        <div className='row info-block'>
          <div className='col-xs-8 no-overflow'><h5>{model.name}</h5></div>
          <div id={model.id} className='in-degree col-xs-2'>{model.inDegree}</div>
          <div id={model.id} className='out-degree col-xs-2'>{model.outDegree}</div>
        </div>
      </div>
    </div>
  );
